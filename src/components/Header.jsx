      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-8 h-8 rounded-full overflow-hidden ring-2 ring-transparent group-hover:ring-blue-500 transition-all">
              <img 
            ...
            <span className={`font-bold text-lg tracking-tight ${theme === 'dark' ? 'text-zinc-100' : 'text-zinc-900'}`}>
          ...
          <div className="flex items-center gap-6">
            <nav className="hidden md:flex items-center gap-1">
              <Link 
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
                  isActive('/') 
                    ? theme === 'dark' ? 'text-zinc-100 bg-zinc-800' : 'text-zinc-900 bg-zinc-100'
            ...
            <div className="hidden lg:flex items-center gap-2 pl-2 border-l border-zinc-200 dark:border-zinc-800">
              <a
                ...
                aria-label={socialsData.github.name}
              >
                <GithubIcon />
              </a>
              <a
                ...
                aria-label={socialsData.linkedin.name}
              >
                <LinkedinIcon />
              </a>
            </div>
            ...
            <button
              ...
              className={`p-2 rounded-full transition-colors ${
                theme === 'dark'
                  ...
                  : 'bg-zinc-100 text-zinc-600 hover:text-orange-500'
              }`}
